...
public interface IJobService
{
    ...
    Task<PaginatedResult<JobFeedDto>> GetJobFeedAsync(string? search, string? skills, string? domain, string[]? workArrangements, bool? isPaidOnly, bool? isEligible, System.Guid? studentUserId, string? sortBy, int page, int pageSize);
