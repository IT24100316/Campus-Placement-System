            ...
            <div className="max-w-7xl mx-auto flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-xs font-semibold text-primary">
                    Showing {activeJobs.length} Active Drives
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                {activeJobs.map((job) => (
                  <div
                    key={job.jobId}
                    className="bg-white rounded-xl border border-slate-200 p-5 flex flex-col justify-between shadow-xs hover:shadow-sm transition-all"
                  >
                    <div className="flex flex-col gap-3">
                      <div className="flex items-center justify-between">
          ...
          <section className="w-full py-6 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
                    Pre-verified university candidates meeting 100% of your eligibility thresholds, screened against your criteria.
                  </p>
                </div>
                <div className="flex items-center gap-2">
                  <button
                    type="button"
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white border border-slate-200 text-slate-700 text-xs font-semibold hover:bg-slate-50 transition-colors shadow-xs cursor-pointer"
                  >
              ...
              <div className="bg-white rounded-xl border border-slate-200 shadow-xs overflow-hidden">
                  ...
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="bg-slate-50 border-b border-slate-200 text-slate-500 text-xs uppercase tracking-wider font-semibold">
                        ...
                        <th className="py-3 px-4">Matched Opening</th>
                        ...
                        return (
                          <tr key={c.id} className="hover:bg-slate-50/70 transition-colors">
                            ...
                            <td className="py-3.5 px-4">
                              ...
                              <span className="block text-slate-500 text-[11px]">{c.batch}</span>
                            </td>
                            <td className="py-3.5 px-4">
                            ...
                            <td className="py-3.5 px-4">
                              <span className="font-medium text-slate-900 text-xs block">{c.matchedOpening}</span>
                              <span className="text-primary text-[11px] font-semibold">{c.matchScore}% Match Score</span>
                            </td>
                            <td className="py-3.5 px-4">
                ...
                {/* Table Footer */}
                <div className="bg-slate-50 px-4 py-3 flex items-center justify-between border-t border-slate-200 text-xs">
                  <span className="text-slate-500">
                    Showing {candidates.length} of {stats.prescreenedStudents} verified applicants
                  </span>
                  <button
                    type="button"
                    className="text-primary font-semibold hover:underline flex items-center gap-1 cursor-pointer"
                  >
                    <span>Open Full Candidate Pipeline ({stats.prescreenedStudents})</span>
